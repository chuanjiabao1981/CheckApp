...
describe "Reports" do
  ...
  let!(:a_zone_org_1_report_4)      {FactoryGirl.create(:report,organization:a_zone_org_1,template:a_template,committer:a_zone_supervisor,status:"finished")}
  ...
  let!(:a_zone_org_1_report_6)      {FactoryGirl.create(:report,organization:a_zone_org_1,template:a_template,committer:a_zone_supervisor,status:"new")}
